...
published:
created: 2026-04-08
description: "엔지니어링의 엄밀함은 사라지지 않는다 — 이동할 뿐이다. AI 에이전틱 패턴 4년의 기록"
tags:
  - "clippings"
---
...
[![AI 에이전틱 패턴의 진화 타임라인 — Prompt → Context → Harness Engineering](https://bits-bytes-nn.github.io/assets/images/three-era-timeline.png)](https://bits-bytes-nn.github.io/assets/images/three-era-timeline.png)
...
[![KV-cache 작동 원리 — 안정 접두어가 비용을 결정한다](https://bits-bytes-nn.github.io/assets/images/kv-cache-mechanism.png)](https://bits-bytes-nn.github.io/assets/images/kv-cache-mechanism.png)
...
![OpenAI Codex 하네스의 관찰성(observability) 스택 — 에이전트 실행 전체를 추적·제어하는 시스템](https://images.ctfassets.net/kftzwdyauwt9/4Xr18TZ5G4Bh8zIgsTFIVK/f7ae689ddd8c31664e39d809b0973425/OAI_Harness_engineering_Giving_Codex_a_full_observability_stack_desktop-light__1_.svg)
